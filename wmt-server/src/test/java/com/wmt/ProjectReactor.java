...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.wmt";
    private static final String ARTIFACT_ID = "wmt";
    private static final String PACKAGE_NAME = "com.wmt";
    private static final String TITLE = "wmt-17统一框架-管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.wmt";
        String artifactIdNew = "wmt";
        String packageNameNew = "com.wmt";
        String titleNew = "wmt-17统一框架-管理系统";
        String projectBaseDirNew = projectBaseDir+"ahzx-wmt-svc"; // 一键改名后，“新”项目所在的目录
