package com.wmt.module.infra.controller.admin.codegen;
...
import com.wmt.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.wmt.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.wmt.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.wmt.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.wmt.module.infra.convert.codegen.CodegenConvert;
...
import com.wmt.module.infra.service.codegen.CodegenService;
...
import static com.wmt.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.wmt.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "wmt"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "AHC")
    })
