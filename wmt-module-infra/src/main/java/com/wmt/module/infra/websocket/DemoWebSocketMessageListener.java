package com.wmt.module.infra.websocket;

import com.wmt.framework.common.enums.UserTypeEnum;
import com.wmt.framework.websocket.core.listener.WebSocketMessageListener;
import com.wmt.framework.websocket.core.sender.WebSocketMessageSender;
import com.wmt.framework.websocket.core.util.WebSocketFrameworkUtils;
import com.wmt.module.infra.websocket.message.DemoReceiveMessage;
import com.wmt.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    @Autowired(required = false) // 由于 wmt.websocket.enable 配置项，可以关闭 WebSocket 的功能，所以这里只能不强制注入
