package com.wmt.module.infra.controller.admin.demo.demo03.erp;
...
import com.wmt.module.infra.controller.admin.demo.demo03.erp.vo.Demo03StudentErpPageReqVO;
import com.wmt.module.infra.controller.admin.demo.demo03.erp.vo.Demo03StudentErpRespVO;
import com.wmt.module.infra.controller.admin.demo.demo03.erp.vo.Demo03StudentErpSaveReqVO;
import com.wmt.module.infra.dal.dataobject.demo.demo03.Demo03CourseDO;
import com.wmt.module.infra.dal.dataobject.demo.demo03.Demo03GradeDO;
import com.wmt.module.infra.dal.dataobject.demo.demo03.Demo03StudentDO;
import com.wmt.module.infra.service.demo.demo03.erp.Demo03StudentErpService;
...
public class Demo03StudentErpController {
    ...
    @PostMapping("/demo03-course/update")
    ...
    @PostMapping("/demo03-course/delete")
    @Parameter(name = "id", description = "编号", required = true)
    ...
    @PostMapping("/demo03-course/delete-list")
    @Parameter(name = "ids", description = "编号", required = true)
    ...
    @PostMapping("/demo03-grade/update")
    ...
    @PostMapping("/demo03-grade/delete")
    @Parameter(name = "id", description = "编号", required = true)
    ...
    @PostMapping("/demo03-grade/delete-list")
    @Parameter(name = "ids", description = "编号", required = true)
