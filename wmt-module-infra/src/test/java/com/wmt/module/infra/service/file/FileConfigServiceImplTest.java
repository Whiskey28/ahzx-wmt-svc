package com.wmt.module.infra.service.file;
...
import com.wmt.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.wmt.module.infra.dal.dataobject.file.FileConfigDO;
import com.wmt.module.infra.dal.mysql.file.FileConfigMapper;
import com.wmt.module.infra.framework.file.core.client.FileClient;
import com.wmt.module.infra.framework.file.core.client.FileClientConfig;
import com.wmt.module.infra.framework.file.core.client.FileClientFactory;
import com.wmt.module.infra.framework.file.core.client.local.LocalFileClient;
import com.wmt.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.wmt.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.wmt.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.wmt.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai")
                .put("domain", "https://www.wmt.cn").build();
        ...
        assertEquals("https://www.wmt.cn", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
        // 验证 cache
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("https://www.wmt.cn")));
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("AHC源码")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.wmt.cn");

        // 调用，并断言
        assertEquals("https://www.wmt.cn", fileConfigService.testFileConfig(id));
    }
