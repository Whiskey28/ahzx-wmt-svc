package com.wmt.module.iot.gateway.config;

import com.wmt.module.iot.core.messagebus.core.IotMessageBus;
import com.wmt.module.iot.gateway.protocol.emqx.IotEmqxAuthEventProtocol;
import com.wmt.module.iot.gateway.protocol.emqx.IotEmqxDownstreamSubscriber;
import com.wmt.module.iot.gateway.protocol.emqx.IotEmqxUpstreamProtocol;
import com.wmt.module.iot.gateway.protocol.http.IotHttpDownstreamSubscriber;
import com.wmt.module.iot.gateway.protocol.http.IotHttpUpstreamProtocol;
import com.wmt.module.iot.gateway.protocol.mqtt.IotMqttDownstreamSubscriber;
import com.wmt.module.iot.gateway.protocol.mqtt.IotMqttUpstreamProtocol;
import com.wmt.module.iot.gateway.protocol.mqtt.manager.IotMqttConnectionManager;
import com.wmt.module.iot.gateway.protocol.mqtt.router.IotMqttDownstreamHandler;
import com.wmt.module.iot.gateway.protocol.tcp.IotTcpDownstreamSubscriber;
import com.wmt.module.iot.gateway.protocol.tcp.IotTcpUpstreamProtocol;
import com.wmt.module.iot.gateway.protocol.tcp.manager.IotTcpConnectionManager;
import com.wmt.module.iot.gateway.service.device.IotDeviceService;
import com.wmt.module.iot.gateway.service.device.message.IotDeviceMessageService;
...
public class IotGatewayConfiguration {
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "wmt.iot.gateway.protocol.http", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "wmt.iot.gateway.protocol.emqx", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "wmt.iot.gateway.protocol.tcp", name = "enabled", havingValue = "true")
    @Slf4j
     ...
     */
    @Configuration
    @ConditionalOnProperty(prefix = "wmt.iot.gateway.protocol.mqtt", name = "enabled", havingValue = "true")
    @Slf4j
