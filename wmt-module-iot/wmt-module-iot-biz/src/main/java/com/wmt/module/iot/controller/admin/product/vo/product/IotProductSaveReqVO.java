package com.wmt.module.iot.controller.admin.product.vo.product;

import com.wmt.framework.common.validation.InEnum;
import com.wmt.module.iot.enums.product.IotLocationTypeEnum;
import com.wmt.module.iot.enums.product.IotNetTypeEnum;
...
public class IotProductSaveReqVO {
    ...
    @Schema(description = "产品图标", example = "https://cn/1.svg")
    private String icon;

    @Schema(description = "产品图片", example = "https://cn/1.png")
