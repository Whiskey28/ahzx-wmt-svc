package com.wmt.module.iot.service.device.property;
...
import com.wmt.module.iot.controller.admin.device.vo.property.IotDevicePropertyHistoryListReqVO;
import com.wmt.module.iot.controller.admin.device.vo.property.IotDevicePropertyRespVO;
import com.wmt.module.iot.core.mq.message.IotDeviceMessage;
import com.wmt.module.iot.dal.dataobject.device.IotDeviceDO;
import com.wmt.module.iot.dal.dataobject.device.IotDevicePropertyDO;
import com.wmt.module.iot.dal.dataobject.product.IotProductDO;
import com.wmt.module.iot.dal.dataobject.thingmodel.IotThingModelDO;
import com.wmt.module.iot.dal.dataobject.thingmodel.model.dataType.ThingModelDateOrTextDataSpecs;
import com.wmt.module.iot.dal.redis.device.DevicePropertyRedisDAO;
import com.wmt.module.iot.dal.redis.device.DeviceReportTimeRedisDAO;
import com.wmt.module.iot.dal.redis.device.DeviceServerIdRedisDAO;
import com.wmt.module.iot.dal.tdengine.IotDevicePropertyMapper;
import com.wmt.module.iot.enums.thingmodel.IotDataSpecsDataTypeEnum;
import com.wmt.module.iot.enums.thingmodel.IotThingModelTypeEnum;
import com.wmt.module.iot.framework.tdengine.core.TDengineTableField;
import com.wmt.module.iot.service.product.IotProductService;
import com.wmt.module.iot.service.thingmodel.IotThingModelService;
...
public class IotDevicePropertyServiceImpl implements IotDevicePropertyService {
    ...
    public void saveDeviceProperty(IotDeviceDO device, IotDeviceMessage message) {
        ...
        // 1. 根据物模型，拼接合法的属性
        // TODO @wmt：【待定 004】赋能后，属性到底以 thingModel 为准（ik），还是 db 的表结构为准（tl）？
