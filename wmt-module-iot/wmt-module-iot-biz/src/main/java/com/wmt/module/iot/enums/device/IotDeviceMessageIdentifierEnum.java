package com.wmt.module.iot.enums.device;

import lombok.Getter;
import lombok.RequiredArgsConstructor;

// TODO @wmt：需要添加对应的 DTO，以及上下行的链路，网关、网关服务、设备等
/**
 * IoT 设备消息标识符枚举
 */
@Deprecated
...
public enum IotDeviceMessageIdentifierEnum {
    ...
    CONFIG_GET("get"), // 上行 TODO wmt：【讨论】暂时没有上行的场景
    CONFIG_SET("set"), // 下行

    SERVICE_INVOKE("${identifier}"), // 下行
    SERVICE_REPLY_SUFFIX("_reply"), // wmt：TODO wmt：【讨论】上行 or 下行
