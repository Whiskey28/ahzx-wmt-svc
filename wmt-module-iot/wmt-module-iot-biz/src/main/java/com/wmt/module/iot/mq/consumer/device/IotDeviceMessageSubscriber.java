package com.wmt.module.iot.mq.consumer.device;
...
import com.wmt.module.iot.core.enums.IotDeviceStateEnum;
import com.wmt.module.iot.core.messagebus.core.IotMessageBus;
import com.wmt.module.iot.core.messagebus.core.IotMessageSubscriber;
...
public class IotDeviceMessageSubscriber implements IotMessageSubscriber<IotDeviceMessage> {
    ...
    public void onMessage(IotDeviceMessage message) {
        ...
        TenantUtils.execute(message.getTenantId(), () -> {
            ...
            // 1.2 更新设备的连接 server
            // TODO wmt：HTTP 网关的上行消息，不应该更新 serverId，会覆盖掉 MQTT 等长连接的 serverId，导致下行消息无法发送。
