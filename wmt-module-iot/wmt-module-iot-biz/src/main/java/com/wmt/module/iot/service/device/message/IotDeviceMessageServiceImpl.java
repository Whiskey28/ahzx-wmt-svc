package com.wmt.module.iot.service.device.message;
...
import com.wmt.module.iot.controller.admin.device.vo.message.IotDeviceMessagePageReqVO;
import com.wmt.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageReqVO;
import com.wmt.module.iot.controller.admin.statistics.vo.IotStatisticsDeviceMessageSummaryByDateRespVO;
import com.wmt.module.iot.core.enums.IotDeviceMessageMethodEnum;
import com.wmt.module.iot.core.mq.message.IotDeviceMessage;
import com.wmt.module.iot.core.mq.producer.IotDeviceMessageProducer;
import com.wmt.module.iot.core.util.IotDeviceMessageUtils;
import com.wmt.module.iot.dal.dataobject.device.IotDeviceDO;
import com.wmt.module.iot.dal.dataobject.device.IotDeviceMessageDO;
import com.wmt.module.iot.dal.tdengine.IotDeviceMessageMapper;
import com.wmt.module.iot.service.device.IotDeviceService;
import com.wmt.module.iot.service.device.property.IotDevicePropertyService;
import com.wmt.module.iot.service.ota.IotOtaTaskRecordService;
...
import static com.wmt.module.iot.enums.ErrorCodeConstants.DEVICE_DOWNSTREAM_FAILED_SERVER_ID_NULL;
...
public class IotDeviceMessageServiceImpl implements IotDeviceMessageService {
    ...
    // TODO @wmt：针对连接网关的设备，是不是 productKey、deviceName 需要调整下；
    @Override
    ...
    private IotDeviceMessage sendDeviceMessage(IotDeviceMessage message, IotDeviceDO device, String serverId) {
        ...
        // TODO wmt：【设计】下行消息需要区分 PUSH 和 PULL 模型
    ...
    // TODO @wmt：可优化：未来逻辑复杂后，可以独立拆除 Processor 处理器
