package com.wmt.module.iot.core.messagebus.config;

import com.wmt.framework.mq.redis.core.RedisMQTemplate;
import com.wmt.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.wmt.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
...
import com.wmt.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.wmt.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.wmt.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "wmt.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "wmt.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    /**
     * 特殊：由于 WmtRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.wmt.framework.mq.redis.config.WmtRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "wmt.iot.message-bus", name = "type", havingValue = "redis")
