package com.wmt.module.pay.framework.pay.core.client.impl.weixin;
...
import com.wmt.framework.common.util.io.FileUtils;
...
import static com.wmt.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V2;
import static com.wmt.module.pay.framework.pay.core.client.impl.weixin.WxPayClientConfig.API_VERSION_V3;
...
public abstract class AbstractWxPayClient extends AbstractPayClient<WxPayClientConfig> {
    ...
    protected void doInit(String tradeType) {
        ...
        if (Objects.equals(config.getApiVersion(), API_VERSION_V2)) {
            ...
            // 参考 https://gitee.com/wmtcode/wmt-ui-admin-vue3/issues/ICUE53 和 https://t.zsxq.com/ODR5V
    ...
    protected PayOrderRespDTO doUnifiedOrder(PayOrderUnifiedReqDTO reqDTO) throws Exception {
        try {
            switch (config.getApiVersion()) {
                ...
                case API_VERSION_V3:
                    // TODO @wmt：【可能是 wxjava 的 bug】参考 https://github.com/binarywang/WxJava/issues/1557
    ...
    private SignatureHeader getRequestHeader(Map<String, String> headers) {
        // 参见 https://gitee.com/zhijiantianya/wmt-cloud/issues/ICSFL6
