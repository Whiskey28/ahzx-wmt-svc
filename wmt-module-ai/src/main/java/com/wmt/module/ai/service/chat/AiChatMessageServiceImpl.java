package com.wmt.module.ai.service.chat;
...
import com.wmt.framework.tenant.core.util.TenantUtils;
import com.wmt.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.wmt.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.wmt.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.wmt.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.wmt.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.wmt.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.wmt.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.wmt.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.wmt.module.ai.dal.dataobject.model.AiModelDO;
import com.wmt.module.ai.dal.dataobject.model.AiToolDO;
import com.wmt.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.wmt.module.ai.enums.ErrorCodeConstants;
import com.wmt.module.ai.enums.model.AiPlatformEnum;
import com.wmt.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.wmt.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.wmt.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.wmt.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.wmt.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.wmt.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.wmt.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.wmt.module.ai.service.model.AiChatRoleService;
import com.wmt.module.ai.service.model.AiModelService;
import com.wmt.module.ai.service.model.AiToolService;
import com.wmt.module.ai.util.AiUtils;
import com.wmt.module.ai.util.FileTypeUtils;
...
import static com.wmt.framework.common.pojo.CommonResult.error;
...
import static com.wmt.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.wmt.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 wmt.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 wmt.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
