package com.wmt.module.ai.framework.ai.core.model;
...
import com.wmt.framework.common.util.spring.SpringUtils;
import com.wmt.module.ai.enums.model.AiPlatformEnum;
import com.wmt.module.ai.framework.ai.config.AiAutoConfiguration;
import com.wmt.module.ai.framework.ai.config.WmtAiProperties;
...
import com.wmt.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.wmt.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            WmtAiProperties.Midjourney properties = SpringUtil.getBean(WmtAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(WmtAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        WmtAiProperties.DouBao properties = new WmtAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(WmtAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        WmtAiProperties.HunYuan properties = new WmtAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(WmtAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        WmtAiProperties.SiliconFlow properties = new WmtAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(WmtAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        WmtAiProperties.XingHuo properties = new WmtAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(WmtAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        WmtAiProperties.BaiChuan properties = new WmtAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(WmtAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        WmtAiProperties.Gemini properties = SpringUtil.getBean(WmtAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        WmtAiProperties.Grok properties = new WmtAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
