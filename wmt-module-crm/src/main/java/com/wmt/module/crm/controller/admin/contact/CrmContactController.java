package com.wmt.module.crm.controller.admin.contact;
...
import com.wmt.module.crm.controller.admin.contact.vo.*;
...
public class CrmContactController {
    ...
    @PostMapping("/delete-business-list")
    ...
    @PostMapping("/delete-business-list2")
    @Operation(summary = "删除联系人与联系人的关联")
    @PreAuthorize("@ss.hasPermission('crm:contact:delete-business')")
