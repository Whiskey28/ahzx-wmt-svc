package com.wmt.module.crm.controller.admin.contact.vo;
...
public class CrmContactRespVO {
    ...
    @Schema(description = "联系人姓名", example = "wmt")
    ...
    @DictFormat(com.wmt.module.system.enums.DictTypeConstants.USER_SEX)
    private Integer sex;
    ...
    @Schema(description = "直属上级名", example = "wmt")
