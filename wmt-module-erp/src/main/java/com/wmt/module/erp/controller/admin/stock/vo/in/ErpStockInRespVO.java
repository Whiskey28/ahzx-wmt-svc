package com.wmt.module.erp.controller.admin.stock.vo.in;
...
import static com.wmt.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockInRespVO {
    ...
    @Schema(description = "供应商名称", example = "AHC")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "附件 URL", example = "https://www.wmt.cn/1.doc")
    private String fileUrl;

    @Schema(description = "创建人", example = "AHC")
    private String creator;
    @Schema(description = "创建人名称", example = "AHC")
