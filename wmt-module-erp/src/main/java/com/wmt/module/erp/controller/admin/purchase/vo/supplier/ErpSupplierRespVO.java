package com.wmt.module.erp.controller.admin.purchase.vo.supplier;
...
public class ErpSupplierRespVO {
    ...
    @Schema(description = "供应商名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "AHC源码")
    @ExcelProperty("供应商名称")
    private String name;

    @Schema(description = "联系人", example = "wmt")
    @ExcelProperty("联系人")
