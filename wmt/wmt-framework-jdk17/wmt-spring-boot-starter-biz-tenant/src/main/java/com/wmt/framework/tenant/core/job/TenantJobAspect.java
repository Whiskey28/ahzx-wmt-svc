package com.wmt.framework.tenant.core.job;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.exceptions.ExceptionUtil;
import cn.hutool.core.util.StrUtil;
import com.wmt.framework.common.util.json.JsonUtils;
import com.wmt.framework.tenant.core.service.TenantFrameworkService;
...
public class TenantJobAspect {
    ...
    public String around(ProceedingJoinPoint joinPoint, TenantJob tenantJob) {
        ...
        tenantIds.parallelStream().forEach(tenantId -> {
            // TODO wmt：先通过 parallel 实现并行；1）多个租户，是一条执行日志；2）异常的情况
