package com.wmt.module.system.service.social;
...
import com.wmt.framework.common.util.cache.CacheUtils;
import com.wmt.framework.common.util.http.HttpUtils;
import com.wmt.framework.common.util.object.BeanUtils;
import com.wmt.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.wmt.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
...
import com.wmt.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.wmt.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.wmt.module.system.dal.dataobject.social.SocialClientDO;
import com.wmt.module.system.dal.mysql.social.SocialClientMapper;
import com.wmt.module.system.dal.redis.RedisKeyConstants;
import com.wmt.module.system.enums.social.SocialTypeEnum;
import com.wmt.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.wmt.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.wmt.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${wmt.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${wmt.wxa-subscribe-message.miniprogram-state:formal}")
