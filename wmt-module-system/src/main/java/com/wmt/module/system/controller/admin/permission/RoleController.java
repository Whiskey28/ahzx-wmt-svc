package com.wmt.module.system.controller.admin.permission;
...
import com.wmt.module.system.controller.admin.permission.vo.role.RoleRespVO;
...
public class RoleController {
    ...
    @PreAuthorize("@ss.hasPermission('system:role:query')")
    public CommonResult<List<RoleRespVO>> getRoleListByUserId(@RequestParam("userId") Long userId) {
        // 获取用户拥有的角色ID集合
        ...
        // 转换为 VO，只返回 id、name、code
        List<RoleRespVO> roleRespList = convertList(roleList, role -> {
