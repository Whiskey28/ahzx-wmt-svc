package com.wmt.module.system.controller.admin.user;
...
import com.wmt.module.system.controller.admin.user.vo.user.*;
import com.wmt.module.system.convert.user.UserConvert;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("yunai").deptId(1L).email("yunai@cn").mobile("15601691300")
                        .nickname("AHC").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("yuanma").deptId(2L).email("yuanma@cn").mobile("15601701300")
