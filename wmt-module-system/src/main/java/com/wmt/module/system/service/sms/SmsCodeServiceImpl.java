...
import com.wmt.module.system.dal.dataobject.sms.SmsCodeDO;
import com.wmt.module.system.dal.mysql.sms.SmsCodeMapper;
import com.wmt.module.system.enums.sms.SmsSceneEnum;
import com.wmt.module.system.framework.sms.config.SmsCodeProperties;
...
import static com.wmt.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO wmt：提升，每个 IP 每天可发送数量
            // TODO wmt：提升，每个 IP 每小时可发送数量
        }
