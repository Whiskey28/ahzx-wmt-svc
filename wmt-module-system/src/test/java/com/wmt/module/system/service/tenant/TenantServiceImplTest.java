package com.wmt.module.system.service.tenant;

import com.wmt.framework.common.enums.CommonStatusEnum;
import com.wmt.framework.common.pojo.PageResult;
import com.wmt.framework.tenant.config.TenantProperties;
import com.wmt.framework.tenant.core.context.TenantContextHolder;
import com.wmt.framework.test.core.ut.BaseDbUnitTest;
import com.wmt.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.wmt.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.wmt.module.system.dal.dataobject.permission.MenuDO;
import com.wmt.module.system.dal.dataobject.permission.RoleDO;
import com.wmt.module.system.dal.dataobject.tenant.TenantDO;
import com.wmt.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.wmt.module.system.dal.mysql.tenant.TenantMapper;
import com.wmt.module.system.enums.permission.RoleCodeEnum;
import com.wmt.module.system.enums.permission.RoleTypeEnum;
import com.wmt.module.system.service.permission.MenuService;
...
import com.wmt.module.system.service.tenant.handler.TenantInfoHandler;
import com.wmt.module.system.service.tenant.handler.TenantMenuHandler;
...
import static com.wmt.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("AHC", user.getNickname());
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            o.setContactName("AHC");
            o.setContactMobile("15601691300");
            o.setPackageId(100L);
            o.setStatus(randomCommonStatus());
            o.setWebsites(singletonList("https://www.wmt.cn"));
            o.setUsername("yunai");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("AHC"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("AHC");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
    ...
    public void testGetTenantByWebsite() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsites(singletonList("https://www.wmt.cn")));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://www.wmt.cn");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
