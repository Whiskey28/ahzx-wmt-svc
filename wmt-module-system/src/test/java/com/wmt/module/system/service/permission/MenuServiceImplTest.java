package com.wmt.module.system.service.permission;

import com.wmt.framework.common.enums.CommonStatusEnum;
import com.wmt.framework.test.core.ut.BaseDbUnitTest;
import com.wmt.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import com.wmt.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.wmt.module.system.dal.dataobject.permission.MenuDO;
import com.wmt.module.system.dal.mysql.permission.MenuMapper;
import com.wmt.module.system.enums.permission.MenuTypeEnum;
...
import static com.wmt.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("wmt").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
