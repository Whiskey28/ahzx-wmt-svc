package com.wmt.module.system.service.user;
...
import com.wmt.framework.common.util.collection.ArrayUtils;
import com.wmt.framework.common.util.collection.CollectionUtils;
import com.wmt.framework.test.core.ut.BaseDbUnitTest;
import com.wmt.module.infra.api.config.ConfigApi;
import com.wmt.module.infra.api.file.FileApi;
import com.wmt.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.wmt.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.wmt.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.wmt.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.wmt.module.system.controller.admin.user.vo.user.UserPageReqVO;
...
import com.wmt.module.system.dal.dataobject.dept.PostDO;
import com.wmt.module.system.dal.dataobject.dept.UserPostDO;
import com.wmt.module.system.dal.dataobject.tenant.TenantDO;
import com.wmt.module.system.dal.dataobject.user.AdminUserDO;
import com.wmt.module.system.dal.mysql.dept.UserPostMapper;
import com.wmt.module.system.dal.mysql.user.AdminUserMapper;
import com.wmt.module.system.enums.common.SexEnum;
import com.wmt.module.system.service.dept.DeptService;
import com.wmt.module.system.service.dept.PostService;
import com.wmt.module.system.service.oauth2.OAuth2TokenService;
import com.wmt.module.system.service.permission.PermissionService;
import com.wmt.module.system.service.tenant.TenantService;
...
import static com.wmt.framework.common.util.collection.SetUtils.asSet;
import static com.wmt.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.wmt.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.wmt.framework.common.util.object.ObjectUtils.cloneIgnoreId;
...
import static com.wmt.framework.test.core.util.RandomUtils.*;
import static com.wmt.module.system.enums.ErrorCodeConstants.*;
import static com.wmt.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("wmtyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("wmtyuanma");
        ...
        assertEquals("wmtyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("wmtyuanma"))).thenReturn("java");
    ...
    public void testGetUserListByNickname() {
        // mock 数据
        AdminUserDO user = randomAdminUserDO(o -> o.setNickname("wmt"));
        userMapper.insert(user);
        // 测试 nickname 不匹配
