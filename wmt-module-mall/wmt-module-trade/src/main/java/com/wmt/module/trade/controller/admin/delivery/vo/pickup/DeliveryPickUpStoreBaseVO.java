package com.wmt.module.trade.controller.admin.delivery.vo.pickup;
...
public class DeliveryPickUpStoreBaseVO {
    ...
    @Schema(description = "门店 logo", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.wmt.cn/1.png")
