package com.wmt.module.trade.convert.order;
...
import com.wmt.framework.common.util.string.StrUtils;
import com.wmt.framework.dict.core.DictFrameworkUtils;
import com.wmt.framework.ip.core.utils.AreaUtils;
import com.wmt.module.member.api.address.dto.MemberAddressRespDTO;
import com.wmt.module.member.api.user.dto.MemberUserRespDTO;
import com.wmt.module.pay.api.order.dto.PayOrderCreateReqDTO;
import com.wmt.module.pay.enums.DictTypeConstants;
import com.wmt.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.wmt.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import com.wmt.module.product.api.sku.dto.ProductSkuRespDTO;
import com.wmt.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import com.wmt.module.product.api.spu.dto.ProductSpuRespDTO;
import com.wmt.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import com.wmt.module.trade.api.order.dto.TradeOrderRespDTO;
import com.wmt.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import com.wmt.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import com.wmt.module.trade.controller.admin.order.vo.*;
import com.wmt.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import com.wmt.module.trade.controller.app.order.vo.*;
import com.wmt.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import com.wmt.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import com.wmt.module.trade.dal.dataobject.order.TradeOrderLogDO;
import com.wmt.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import com.wmt.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import com.wmt.module.trade.framework.order.config.TradeOrderProperties;
import com.wmt.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static com.wmt.framework.common.util.collection.CollectionUtils.convertMap;
import static com.wmt.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static com.wmt.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default PayOrderCreateReqDTO convert(TradeOrderDO order, List<TradeOrderItemDO> orderItems,
        ...
        createReqDTO.setBody(subject); // TODO wmt：临时写死
        // 订单相关字段
    ...
    default BrokerageAddReqBO convert(MemberUserRespDTO user, TradeOrderItemDO item,
        ...
        if (BooleanUtil.isTrue(spu.getSubCommissionType())) {
            // 特殊：单独设置的佣金需要乘以购买数量。关联 https://gitee.com/wmtcode/wmt-mall-uniapp/issues/ICY7SJ
