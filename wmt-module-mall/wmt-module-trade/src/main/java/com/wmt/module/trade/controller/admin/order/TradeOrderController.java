package com.wmt.module.trade.controller.admin.order;
...
import com.wmt.module.trade.service.order.TradeOrderLogService;
...
public class TradeOrderController {
    ...
    @PostMapping("/pick-up-by-verify-code")
    @Operation(summary = "订单核销")
