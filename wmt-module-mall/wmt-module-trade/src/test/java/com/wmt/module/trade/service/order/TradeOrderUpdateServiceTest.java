...
import com.wmt.module.member.api.user.MemberUserApi;
...
import com.wmt.module.product.api.sku.ProductSkuApi;
import com.wmt.module.product.api.spu.ProductSpuApi;
import com.wmt.module.promotion.api.coupon.CouponApi;
import com.wmt.module.system.api.notify.NotifyMessageSendApi;
import com.wmt.module.trade.controller.admin.delivery.vo.express.DeliveryExpressCreateReqVO;
...
import com.wmt.module.trade.enums.order.TradeOrderRefundStatusEnum;
import com.wmt.module.trade.enums.order.TradeOrderStatusEnum;
import com.wmt.module.trade.framework.order.config.TradeOrderConfig;
import com.wmt.module.trade.framework.order.config.TradeOrderProperties;
import com.wmt.module.trade.service.cart.CartServiceImpl;
import com.wmt.module.trade.service.delivery.DeliveryExpressService;
import com.wmt.module.trade.service.delivery.DeliveryExpressServiceImpl;
import com.wmt.module.trade.service.message.TradeMessageServiceImpl;
import com.wmt.module.trade.service.order.handler.TradeOrderHandler;
import com.wmt.module.trade.service.price.TradePriceServiceImpl;
import com.wmt.module.trade.service.price.calculator.TradePriceCalculator;
...
//        // mock 方法（用户收件地址的校验）
//        MemberAddressRespDTO addressRespDTO = new MemberAddressRespDTO().setId(10L).setUserId(userId).setName("wmt")
...
//        assertEquals(tradeOrderDO.getReceiverName(), "wmt");
