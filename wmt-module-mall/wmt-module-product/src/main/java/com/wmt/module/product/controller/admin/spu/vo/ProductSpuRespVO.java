package com.wmt.module.product.controller.admin.spu.vo;

import com.wmt.framework.excel.core.annotations.DictFormat;
import com.wmt.framework.excel.core.convert.DictConvert;
import com.wmt.framework.excel.core.convert.MoneyConvert;
import com.wmt.module.product.enums.DictTypeConstants;
...
public class ProductSpuRespVO {
    ...
    @Schema(description = "商品封面图", requiredMode = Schema.RequiredMode.REQUIRED, example = "https://www.wmt.cn/xx.png")
    @ExcelProperty("商品封面图")
    private String picUrl;

    @Schema(description = "商品轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.wmt.cn/xx.png, https://www.wmt.cn/xxx.png]")
