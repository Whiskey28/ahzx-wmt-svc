package com.wmt.module.promotion.controller.admin.seckill.vo.config;
...
public class SeckillConfigBaseVO {
    ...
    @Schema(description = "秒杀轮播图", requiredMode = Schema.RequiredMode.REQUIRED, example = "[https://www.wmt.cn/xx.png]")
