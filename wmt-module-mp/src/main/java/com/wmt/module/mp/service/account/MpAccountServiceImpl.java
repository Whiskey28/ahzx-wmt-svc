package com.wmt.module.mp.service.account;
...
import com.wmt.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.wmt.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.wmt.module.mp.convert.account.MpAccountConvert;
import com.wmt.module.mp.dal.dataobject.account.MpAccountDO;
import com.wmt.module.mp.dal.mysql.account.MpAccountMapper;
import com.wmt.module.mp.enums.ErrorCodeConstants;
...
import static com.wmt.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 wmt-module-mp - 表结构未导入]");
            }
