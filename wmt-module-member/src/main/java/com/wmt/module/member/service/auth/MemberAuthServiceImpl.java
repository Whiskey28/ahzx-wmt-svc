package com.wmt.module.member.service.auth;
...
import com.wmt.module.system.api.social.SocialUserApi;
...
import com.wmt.module.system.api.social.dto.SocialWxPhoneNumberInfoRespDTO;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO wmt：后续 member user 手机非强绑定，这块需要做下调整；
