...
import com.wmt.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import com.wmt.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, WmtRedisAutoConfiguration.class})
