...
import com.wmt.framework.redis.config.WmtRedisAutoConfiguration;
...
import com.wmt.module.member.dal.mysql.user.MemberUserMapper;
...
// TODO @wmt：单测的 review，等逻辑都达成一致后
/**
 * {@link MemberAuthService} 的单元测试类
 *
 * @author 宋天
 */
@Import({MemberAuthServiceImpl.class, WmtRedisAutoConfiguration.class})
public class MemberAuthServiceTest extends BaseDbAndRedisUnitTest {

    // TODO @wmt：登录相关的单测，待补全
